    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="text-2xl font-bold">${dashboard?.balance ?? 0}</div>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <div className="text-gray-500">Your Trades</div>
          <div className="text-2xl font-bold">{dashboard?.trades ?? 0}</div>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <div className="text-gray-500">Copy Groups</div>
          <div className="text-2xl font-bold">{dashboard?.groups ?? 0}</div>
        </div>
      </div>
    </div>
  );
